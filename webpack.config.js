...
// We can include Webpack plugins, through addons, that do not need to run every
// time we are developing. We will see an example when we set up 'Bundle
// Analyzer'
...
// 'env' will contain the environment variable from 'scripts' section in
// 'package.json'. console.log(env); => { env: 'dev' }
module.exports = env => {
    ...
    // 'webpack-merge' will combine our shared configurations, the environment
